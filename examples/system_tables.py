...
QUERY_TO_TABLE_TABLE = "example_catalog.example_schema.query_to_table"
...
mappings = [
    ...
    TripleMap(
        ...
        predicate_object_maps=[
            ...
            (
                iri.pred("in_table"),
                iri.table("table_catalog", "table_schema", "table_name"),
            ),
        ],
    ),
    TripleMap(
    ...
    TripleMap(
        ...
        predicate_object_maps=[
            (
                iri.pred("queries"),
                iri.table("catalog_name", "schema_name", "table_name"),
            )
        ],
    ),
    TripleMap(
